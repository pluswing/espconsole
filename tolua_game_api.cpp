...
** Generated automatically by tolua++-1.0.92 on Sun Jul 21 22:17:53 2019.
*/
...
#endif
  {
   unsigned int tolua_ret = (unsigned int)  self->btn(button);
...
#endif
  {
   unsigned int tolua_ret = (unsigned int)  self->btnp(button);
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
...
#endif
  {
   unsigned int tolua_ret = (unsigned int)  self->btnr(button);
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
